...
import { useProducts } from "@/context/ProductsContext";
 ...
 function Arrivals()  {
  ...
  return (
    <div className="my-14">
        <h2 className={`${eb_garamond_init.variable} text-[#A37B5C] text-3xl custom-heading border-[#A37B5C] border-b-2`}>Shop New Arrivals</h2>
        <div>
      ...
      {products.slice(3,11).map((product, i) => (
        ...
        >
          ...
          />
          <div className="p-1.5">
          <p className="text-[#A37B5C]">{product.name}</p>
          <p className="text-[#D2B48C] text-sm font-medium">${product.price}.00 USD</p>
          </div>
