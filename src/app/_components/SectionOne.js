...
const SectionTwo = () => {
  return (
    <div className='w-full bg-[#D2B48C] mt-20 flex flex-col items-center justify-center h-[40vh]'>
        ...
        className="w-full py-2 px-4 pr-10 border-[#A37B5C] bg-inherit border placeholder-white text-white shadow-sm focus:outline-none focus:ring-3 focus:ring-[#D2B48C] focus:border-[#A37B5C]"
      />
