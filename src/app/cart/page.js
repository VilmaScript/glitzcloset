      ...
      {!!cart.length && (
        <div className="md:flex md:gap-10">
          ...
          <div className="md:w-3/4 w-full">
            ...
            <div className="overflow-x-auto md:-mx-0 -mx-8">
                    ...
                    <tr key={item._id} className="border-b border-secondary">
                      ...
                      <td className="p-2 flex items-center gap-4 min-w-[180px]">
                        <Image
                          ...
                          className="object-cover"
                        />
                        <span className="font-eb-garamond text-primary text-base md:text-xl font-semibold">
                          {item.slug}
                        </span>
                      </td>
                      {/* category */}
          ...
          {/* ------------------ order summary ------------------ */}
          <div className="md:w-1/4 w-full mt-8 md:mt-0 self-start p-4 border border-gray-200 shadow-md">
            <h3 className="text-lg font-semibold mb-3">Order Summary</h3>
